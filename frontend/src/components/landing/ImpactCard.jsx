const ImpactCard = ({ impacts }) => {
    ...
    return (
        <div className="relative h-28 w-full xl:w-60 flex item-center justify-center rounded-3xl overflow-hidden duration-300 group">
            {/* Background Image */}
            <img
                src={image}
                alt={title}
                className="absolute inset-0 w-full  xl:w-60  h-full object-cover"
            />
